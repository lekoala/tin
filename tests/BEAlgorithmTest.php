...
class BEAlgorithmTest extends TestCase
{
    ...
    const VALID_NUMBER2 = '02073034044'; // a valid number in year 2k
    const INVALID_NUMBER_CHECK = '00012511120';
    const INVALID_NUMBER_LENGTH = '0001251112020';

    public function testValidNumber()
    {
        $this->assertTrue(TINValid::checkTIN('be', self::VALID_NUMBER), "Failed to validate " . self::VALID_NUMBER);
        $this->assertTrue(TINValid::checkTIN('be', self::VALID_NUMBER2), "Failed to validate " . self::VALID_NUMBER2);
    }
